...
#define WORKER_RENDER worker_rend_julia
#define RENDER_BLOCK render_block_julia_threads
...
#define WORKER_RENDER worker_rend_julia_depth
#define RENDER_BLOCK render_block_julia_threads_depth
#define COMPUTE_PIX compute_pix_julia_threads
#define PALETTE compute_color_depth
#include "render_threads_template.h"
#undef WORKER_RENDER
